...
<head>
    ...
    <title>Edit Admin - PhoneStore.Com</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Edit Data Admin </h2>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <?php
                                    ...
                                    $id_admin= $_GET['id'];
                                    $data = mysqli_query($connect,"select * from data_admin where id_admin='$id_admin'");
                                    while($data_admin = mysqli_fetch_array($data)){
                                ?>
                                    <form id="form" method="post" action="includes/action/conn-edit-admin.php">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="text" required="" value="<?php echo $data_admin['nama_admin']; ?>" name="nama_admin" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-3 col-lg-2 col-form-label text-right">Username</label>
                                            <div class="col-9 col-lg-10">
                                                <input type="text" required="" value="<?php echo $data_admin['username']; ?>" name="username_admin"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Email</label>
                                            <div class="col-9 col-lg-10">
                                                <input id="inputEmail2" type="email" required="" data-parsley-type="email" value="<?php echo $data_admin['email']; ?>" name="email_admin" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
